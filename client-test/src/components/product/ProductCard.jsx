  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden rounded-lg bg-gray-100">
        {/* Product Image */}
        <img
          src={product.thumbnail || 'https://via.placeholder.com/400x400'}
          alt={product.title}
        ...
        <button
          ...
          disabled={loading}
          className={`absolute bottom-3 right-3 p-2 bg-white rounded-full shadow-lg transition-all duration-200 ${
        ...
        <div className="flex items-center space-x-2">
          ...
          {product.compare_at_price && product.compare_at_price > price && (
            <p className="text-sm text-gray-500 line-through">
              {formatPrice(product.compare_at_price, currencyCode)}
            </p>
          )}
        </div>
