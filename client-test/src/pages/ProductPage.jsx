...
const ProductPage = () => {
  ...
  console.log('The product -> ', productMedusa);
  if (!productMedusa) {
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="text-3xl font-bold text-gray-900">
              {selectedVariant && formatPrice(selectedVariant.prices?.[0]?.amount, selectedVariant.prices?.[0]?.currency_code)}
            </div>
            ...
            {/* Variants */}
            {productMedusa.variants && productMedusa.variants.length > 1 && (
              <div>
